...
<div class="container mx-auto flex md:flex">
    <div class="md:w-1/2">
        <img src="{{ asset('uploads') . '/' . $post->imagen }}" alt="Imagen del post {{ $post }}">
        ...
        <div class="p-3 flex item-center gap-4">
            @auth
                ...
                <form method="POST" action="{{ route('posts.likes.destroy', $post) }}">
                    ...
                    <div class="my-4">
                        <button type="submit">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="red" viewBox="0 0 24 24" stroke="#ef4444" stroke-width="2">
        ...
        <div class="p-3">
            ...
            <p class="text-sm text-gray-500"> {{ $post->descripcion }} </p>
        </div>
